...
public class HandAnimator : MonoBehaviour
{
  ...
  //  [SerializeField] private XRInputValueReader<float> m_FistInput = new XRInputValueReader<float>("Fist");
   ...
   */
    ...
    private void Update()
    {
      ...
      /*  if(m_FistInput != null)
        {
            var fistVal = m_FistInput.ReadValue();
            SetFingerAnimationValues(fistFingers, fistVal);
